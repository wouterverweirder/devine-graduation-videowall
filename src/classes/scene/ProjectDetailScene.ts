...
import { SceneBase, SceneBaseProps, SceneState } from "./SceneBase";
...
export type ProjectDetailSceneProps = SceneBaseProps & {
  project: Project;
}

class ProjectDetailScene extends SceneBase {

  declare props: ProjectDetailSceneProps;

  projectPlanes:VisualBase[] = [];
  colorPlanes:VisualBase[] = [];
