...
export type ProjectQuotePlaneProps = VisualBaseProps & {
  data: ProjectQuotePlaneData;
};
...
export class ProjectQuotePlane extends CanvasPlane {
  ...
  quoteImage: HTMLImageElement;

  declare props: ProjectQuotePlaneProps;
  ...
  async createInitalCanvasContent() {
    ...
    const quote:string = this.props.data.attributes.quote;
