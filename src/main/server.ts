...
import { shutdown } from './node-shutdown-windows';
...
// let htmlFolderPath:string;
// let srcFolderPath:string;
...
const init = async (argvValue:ArgV) => {
  ...
  server = new http.Server(expressApp);
  ...
  //   console.log('index.html requested', path.resolve(htmlFolderPath, 'index.html'));
...
const sendToArduino = (messageString:string) => {
