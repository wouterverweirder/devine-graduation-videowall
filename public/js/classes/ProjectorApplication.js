...
class ProjectorApplication extends Application {
  ...
  applicationSpecificRender = () => {
    this.cameras.forEach(camera => {
      ...
      const left = Math.floor( this.config.appDimensions.width * screen.output.left );
      const bottom = Math.floor( this.config.appDimensions.height * screen.output.bottom );
      const width = Math.floor( this.config.appDimensions.width * screen.output.width );
      const height = Math.floor( this.config.appDimensions.height * screen.output.height );
